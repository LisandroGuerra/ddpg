        ...
        <form>
            <div class="form-group row">
                ...
                <div class="col-sm-12 d-flex justify-content-center">
                    <input type="text" inputmode="numeric" id="rect_siape" placeholder="Matrícula SIAPE">
                </div>
            </div>
            <div class="card m-3">
            ...
            <div class="form-group row">
                ...
                <select id="rect_super" class="custom-select ml-3 mr-3">
            ...
            <div class="form-group row">
                ...
                <select id="rect_program" class="custom-select ml-3 mr-3">
